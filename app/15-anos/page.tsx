...
export default function QuinzeAnosPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-gradient-to-b from-indigo-950 via-purple-950 to-slate-950">
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-gold-500/10 via-gold-400/10 to-gold-500/10 rounded-full blur-[120px] pointer-events-none" />

      {/* Header - Elegante */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled
            ? 'bg-slate-950/95 backdrop-blur-xl border-b border-gold-500/20 shadow-2xl shadow-gold-500/10'
            : 'bg-transparent'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gold-400 via-gold-400 to-gold-600 flex items-center justify-center shadow-lg shadow-gold-500/30">
              ...
              <div>
                ...
                <span className="text-xs text-gold-400 font-medium tracking-widest uppercase">15 Anos</span>
              </div>
            </div>

            <button
              onClick={() => setIsModalOpen(true)}
              className="group px-5 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-gold-400 via-gold-400 to-gold-500 text-slate-900 font-bold rounded-full hover:from-gold-300 hover:via-gold-300 hover:to-gold-400 transition-all duration-300 flex items-center gap-2 shadow-lg shadow-gold-500/30 text-sm sm:text-base"
            >
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-gold-500/20 to-gold-400/20 rounded-full border border-gold-500/40 mb-6 shadow-lg backdrop-blur-sm">
                <Sparkles className="w-5 h-5 text-gold-400" />
                <span className="text-gold-300 text-sm font-semibold tracking-wide">Música Exclusiva para Debutantes</span>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6">
                Sua{' '}
                <span className="bg-gradient-to-r from-gold-300 via-gold-300 to-gold-400 bg-clip-text text-transparent">
                  valsa dos sonhos
                </span>
                {' '}começa aqui
              </h1>
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-8 leading-relaxed">
                ...
                <span className="text-gold-400 font-semibold">algo inesquecível</span>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="group px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-gold-400 via-gold-400 to-gold-500 text-slate-900 text-base sm:text-lg font-bold rounded-full hover:from-gold-300 hover:via-gold-300 hover:to-gold-400 transition-all duration-300 shadow-xl shadow-gold-500/30 hover:shadow-2xl hover:shadow-gold-500/40 hover:-translate-y-1 flex items-center justify-center gap-3"
                >
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6">
                <div className="flex items-center gap-2 text-slate-300">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gold-500/20 to-gold-400/20 border border-gold-500/30 flex items-center justify-center">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -inset-4 bg-gradient-to-r from-gold-500/40 via-purple-500/40 to-blue-500/40 rounded-3xl blur-2xl opacity-60" />

                {/* Main image container */}
                <div className="relative rounded-3xl overflow-hidden border-2 border-gold-500/30 shadow-2xl shadow-gold-500/20">
                  <div className="aspect-[4/5] relative bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-gold-500/10 via-transparent to-purple-500/10" />
                  </div>

                  {/* Floating badge */}
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-slate-950/80 backdrop-blur-xl rounded-2xl p-4 border border-gold-500/30">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gold-400 to-gold-400 flex items-center justify-center shadow-lg">
                          <Music className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <p className="text-white font-bold text-sm">Sua noite especial</p>
                          <p className="text-gold-400 text-xs">Com uma valsa única e exclusiva</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Decorative elements */}
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-gold-400 to-gold-400 rounded-full blur-xl opacity-40" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-4">
              Como <span className="bg-gradient-to-r from-gold-300 to-gold-300 bg-clip-text text-transparent">funciona</span>?
            </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { icon: <Edit3 className="w-6 h-6" />, title: "Conte sua história", desc: "Fale sobre você, sua família e momentos especiais", gradient: "from-gold-400 to-gold-400" },
              ...
              <motion.div
                ...
                className="text-center p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 backdrop-blur-sm hover:border-gold-500/30 transition-all duration-300 group"
              >
      ...
      <section id="planos" className="py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gold-500/10 rounded-full blur-[150px]" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gold-500/20 to-gold-400/20 rounded-full border border-gold-500/30 mb-6">
              <Crown className="w-5 h-5 text-gold-400" />
              <span className="text-gold-300 text-sm font-bold tracking-wide">PLANOS ESPECIAIS</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4">
              Escolha seu{' '}
              <span className="bg-gradient-to-r from-gold-300 via-gold-300 to-gold-400 bg-clip-text text-transparent">plano</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
            {PLANOS.map((plano, index) => (
              ...
              >
                {plano.popular && (
                  <div className="absolute -inset-1 bg-gradient-to-r from-gold-400 via-gold-400 to-gold-400 rounded-[28px] blur-lg opacity-40 group-hover:opacity-60 transition-opacity" />
                )}

                <div className={`relative bg-gradient-to-br ${
                  plano.popular
                    ? 'from-slate-800/90 via-slate-900/95 to-slate-800/90 border-gold-500/50'
                  ...
                  {plano.popular && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <span className="bg-gradient-to-r from-gold-400 via-gold-400 to-gold-400 text-slate-900 text-xs sm:text-sm font-black px-4 sm:px-6 py-2 rounded-full shadow-lg shadow-gold-500/30 flex items-center gap-2">
                        <Crown className="w-4 h-4" />
                        MAIS ESCOLHIDO
                      </span>
                    </div>
                  ...
                  <div className="text-center mb-6 sm:mb-8 pt-2">
                    ...
                    <div className="flex items-baseline justify-center gap-1">
                      <span className={`text-lg ${plano.popular ? 'text-gold-400' : 'text-purple-300'}`}>R$</span>
                    ...
                    <p className={`text-xs sm:text-sm mt-2 ${plano.popular ? 'text-gold-400/80' : 'text-purple-300/80'}`}>Entrega em {plano.entrega}</p>
                  </div>

                  <div className={`h-px mb-6 ${plano.popular ? 'bg-gradient-to-r from-transparent via-gold-500/50 to-transparent' : 'bg-gradient-to-r from-transparent via-white/20 to-transparent'}`} />
                    ...
                    {plano.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                          plano.popular
                            ? 'bg-gradient-to-br from-gold-400 to-gold-400'
                  ...
                  <button
                    ...
                    className={`w-full py-4 rounded-xl font-bold text-base sm:text-lg transition-all duration-300 flex items-center justify-center gap-2 ${
                      plano.popular
                        ? 'bg-gradient-to-r from-gold-400 via-gold-400 to-gold-400 text-slate-900 hover:from-gold-300 hover:via-gold-300 hover:to-gold-300 shadow-lg shadow-gold-500/30'
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
              Debutantes que{' '}
              <span className="bg-gradient-to-r from-gold-300 to-gold-300 bg-clip-text text-transparent">amaram</span>
            </h2>
          </motion.div>
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -50 }}
                className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-gold-500/20 text-center"
              >
                ...
                <p className="text-sm text-gold-400">{TESTIMONIALS_15[currentTestimonial].role}</p>
              </motion.div>
            </AnimatePresence>
              ...
              {TESTIMONIALS_15.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    i === currentTestimonial ? 'w-8 bg-gradient-to-r from-gold-400 to-gold-400' : 'w-2 bg-slate-600'
                  }`}
                />
              ))}
            </div>
            ...
            {FAQS_15.map((faq, index) => (
              <motion.div
                ...
                className={`bg-gradient-to-br from-white/10 to-white/5 border-2 rounded-2xl overflow-hidden transition-all backdrop-blur-sm ${
                  openFaq === index ? 'border-gold-500/50' : 'border-white/10'
                }`}
              >
                <button
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 text-gold-400 transition-transform ${openFaq === index ? 'rotate-180' : ''}`} />
                </button>
                <AnimatePresence>
                  {openFaq === index && (
                    <motion.div
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-gold-600 via-gold-400 to-gold-500" />
      ...
      <footer className="py-10 bg-slate-950 text-center border-t border-white/10">
        <div className="flex items-center justify-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gold-400 to-gold-400 flex items-center justify-center shadow-lg">
        ...
        <a href="/" className="text-gold-400 text-sm hover:underline mt-2 inline-block">
